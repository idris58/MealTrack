      ...
      <Card className="overflow-hidden border-border/80 shadow-sm transition-shadow hover:shadow-md">
        ...
        <CardContent className="p-5 sm:p-6 space-y-4">
          <div className="rounded-xl border bg-background/70 p-4 space-y-3">
            ...
            <div className={cn('space-y-3 border-t pt-3', !globalEnabled && 'opacity-60')}>
              <div className="flex items-start justify-between gap-4">
                ...
                <Switch
                  ...
                  disabled={!globalEnabled || preferencesLoading || preferencesSaving}
              ...
              <label className="block space-y-1 text-xs font-medium">
                ...
                <input
                  type="time"
                  value={reminderTime}
                  disabled={!globalEnabled || !mealRemindersEnabled || preferencesLoading || preferencesSaving}
              ...
              <p className="text-xs text-muted-foreground">
                Next reminder: {globalEnabled && mealRemindersEnabled ? nextRun : 'Enable meal reminders to schedule.'}
              </p>
              <Button
                type="button"
                size="sm"
            ...
            {permission === 'denied' ? (
              <div className="rounded-xl border border-amber-500/30 bg-amber-500/[0.08] p-3 space-y-2.5">
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs font-semibold text-foreground">Notifications blocked in browser</p>
                    <p className="text-[11px] text-muted-foreground leading-relaxed mt-0.5">
                      Your browser has blocked notifications for MealTrack. Change permission in your browser address bar to allow alerts.
                    </p>
                  </div>
                </div>
              ...
              <p className="border-t pt-2 text-xs text-muted-foreground">This browser does not support Web Push notifications.</p>
            ) : null}
